          ...
          children: <Widget>[
            ...
            BlocBuilder<DoctorHomeBloc, DoctorHomeState>(
              ...
              builder: (context, state) {
                ...
                DateTime upcomingAppointmentDate = state.upcomingAppointmentIndex !=  -1 ?   DateTime.parse(state.appointments[state.upcomingAppointmentIndex]['date']) : DateTime.now();
                String formattedDate = DateFormat('MMM, dd, yyyy').format(upcomingAppointmentDate);
                return AppointmentDetailsWidget(
                    customerName: state.upcomingCustomerName,
                    day: '$formattedDate',
                    time: state.upcomingAppointmentIndex == -1 ? '0' :  mapPeriod(state.appointments[state.upcomingAppointmentIndex]['period'].toString()),
