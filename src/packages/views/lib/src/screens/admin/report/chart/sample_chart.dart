...
import 'package:views/src/screens/admin/report/chart/indicator.dart';
...
class DCPieChartState extends State<DCPieChart> {
  ...
  Widget build(BuildContext context) {
    const ColorScheme colorScheme = DocCareLightColorScheme();
    return AspectRatio(
      aspectRatio: 1.3,
      child: Row(
        children: <Widget>[
  ...
  List<PieChartSectionData> showingSections(
    ...
    final DocCareLightColorScheme colorScheme = const DocCareLightColorScheme();
