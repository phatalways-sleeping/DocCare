...
/// [DCReceptionistDrawer] is the drawer for the customer role
class DCReceptionistDrawer extends StatefulWidget {
  ...
  @override
  State<DCReceptionistDrawer> createState() => _DCReceptionistDrawerState();
}

class _DCReceptionistDrawerState extends State<DCReceptionistDrawer>
    ...
    return BaseDrawer(
      ...
      items: [
        DCDrawerItem(
          ...
          onTap: (context) => Navigator.pushNamed(context, '/receptionist/profile'),
